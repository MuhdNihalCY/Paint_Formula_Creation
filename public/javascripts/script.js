...
function ADTBEmpPasstogglePassword(id) {
    const passwordInput = document.getElementById(`ADTBEmpPass${id}`);
    const passwordIcon = document.getElementById(`ADTBpassword-icon${id}`);
